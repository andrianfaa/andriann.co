...
export default function TimelineCard({
  ...
  return (
    <li className="relative pl-6 pb-4 last:pb-0 mb-4 last:mb-0 group">
      <div id="dot" className="transition-all duration-300 w-3 h-3 rounded-full bg-slate-500 absolute -left-1.5 top-2 group-hover:bg-primary group-hover:ring-8 group-hover:ring-primary group-hover:ring-opacity-25" />
